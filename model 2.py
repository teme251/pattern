...
def anomaly_detection(df, X):
    ...
    if 'AvgScaleScoreBySubjectSchool' in df.columns and 'ScaleScore' in df.columns:
        ...
        plt.close()
        st.image('anomalies_scatterplot.png', use_column_width=True)
    else:
        st.write("### Required columns for anomaly scatterplot not found.")
